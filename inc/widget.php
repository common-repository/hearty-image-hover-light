...
class HeartyImageHoverLightWidget extends WP_Widget {

	function __construct() {

		$widget_options = array(
			'classname' => 'heartyimagehoverlight_widget',
			'description' => 'Displays a HeartyImageHoverLight instance',
		);

		parent::__construct( 'heartyimagehoverlight_widget', 'HeartyImageHoverLight Widget', $widget_options );
